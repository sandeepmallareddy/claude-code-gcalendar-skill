...
describe('CalendarClient Integration Tests', () => {
    let client;
    beforeAll(async () => {
        client = await (0, calendar_client_1.createCalendarClient)();
    });
    describe('listEvents', () => {
        it('should list events within date range', async () => {
            const result = await client.listEvents(new Date('2024-01-15T00:00:00Z'), new Date('2024-01-16T00:00:00Z'));
        ...
        it('should handle empty result', async () => {
            ...
            const result = await client.listEvents(new Date('2024-01-01'), new Date('2024-01-02'));
            expect(result.success).toBe(true);
    ...
    describe('getEvent', () => {
        ...
        it('should handle non-existent event', async () => {
            ...
            const mockClient = new calendar_client_1.CalendarClient(notFoundApi, {});
    ...
    describe('getFreeBusy', () => {
        it('should return busy times', async () => {
            const result = await client.getFreeBusy(new Date('2024-01-15T00:00:00Z'), new Date('2024-01-16T00:00:00Z'));
            expect(result.success).toBe(true);
    ...
    describe('searchEvents', () => {
        it('should search events by query', async () => {
            const result = await client.searchEvents('standup', new Date('2024-01-15'), new Date('2024-01-16'));
            expect(result.success).toBe(true);
...
//# sourceMappingURL=calendar-client.test.js.map